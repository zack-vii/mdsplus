...
public final class ProfileDialog extends JDialog implements WaveformListener{
	...
	public ProfileDialog(final Waveform parent, final Waveform source_profile, final boolean reversed){
	...
	public final void addProfileLine() {
		...
		this.w_profile_line.setReversed(this.wave[0].isReversed());
	...
	public final void processWaveformEvent(final WaveformEvent e) {
		switch(e.getID()){
			case WaveformEvent.PROFILE_UPDATE:
				if(this.isShowing()) if(e.frame_type == FrameData.BITMAP_IMAGE_32 || e.frame_type == FrameData.BITMAP_IMAGE_16){
