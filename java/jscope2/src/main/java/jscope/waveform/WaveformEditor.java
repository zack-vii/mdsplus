...
final class WaveformEditor extends Waveform{
		...
		this.addMouseListener(new MouseAdapter(){
			...
			public final void mousePressed(final MouseEvent e) {
				...
				if((e.getModifiers() & Event.META_MASK) != 0) // If MB3
				{
					...
					newSig.setMarker(Marker.SQUARE);
	...
	protected void setupCopyPaste() {
		...
		this.addKeyListener(new KeyListener(){
			...
			@Override
			public void keyReleased(final KeyEvent ke) {/*stub*/}

			@Override
			public void keyTyped(final KeyEvent ke) {/*stub*/}
		});
	}
}
