...
public final class jScopeDefaultValues{
	...
	private Map<String, String>	public_variables	= null;
	...
	public boolean getIsEvaluated() {
		return this.is_evaluated || this.public_variables == null || this.public_variables.size() == 0;
	}

	public Map<String, String> getPublicVariables() {
		return this.public_variables;
	}

	public boolean isSet() {
		return(this.public_variables != null && this.public_variables.size() > 0);
	}
	...
	public void setPublicVariables(final Map<String, String> public_variables) {
		...
		if(public_variables == null || !public_variables.equals(this.public_variables)){
			this.is_evaluated = false;
			this.public_variables = public_variables;
		}
	}
}
