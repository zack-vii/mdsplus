...
JNIEXPORT jint JNICALL Java_jTraverser_Database_create(JNIEnv * env, jobject obj, jint shot) {
  int status;
  //jfieldID name_fid;
...
JNIEXPORT jint JNICALL Java_jTraverser_Database_open(JNIEnv * env, jobject obj) {
  int status;
...
JNIEXPORT jint JNICALL Java_jTraverser_Database_openNew(JNIEnv * env, jobject obj) {
  int status;
...
JNIEXPORT void JNICALL Java_jTraverser_Database_write(JNIEnv * env, jobject obj, jint context) {
  int status;
  jfieldID name_fid, shot_fid;
  jclass cls = (*env)->GetObjectClass(env, obj);
  const char *name;
...
JNIEXPORT void JNICALL Java_jTraverser_Database_close(JNIEnv * env, jobject obj, jint context)
{
  int status = 1;
...
JNIEXPORT void JNICALL Java_jTraverser_Database_quit(JNIEnv * env, jobject obj, jint context)
{
  int status;
  jfieldID name_fid, shot_fid;
  jclass cls = (*env)->GetObjectClass(env, obj);
...
JNIEXPORT jobject JNICALL Java_jTraverser_Database_evaluateData
    (JNIEnv * env, jobject obj, jobject jnid, jint context) {
  int nid, status;
...
JNIEXPORT jobject JNICALL Java_jTraverser_Database_evaluateSimpleData
...
JNIEXPORT void JNICALL Java_jTraverser_Database_putRow
...
JNIEXPORT void JNICALL Java_jTraverser_Database_setFlags(JNIEnv * env, jobject obj, jobject jnid, jint jflags) {
    int nid, status;
...
JNIEXPORT void JNICALL Java_jTraverser_Database_clearFlags(JNIEnv * env, jobject obj, jobject jnid, jint jflags) {
    int nid, status;
    int flags = (int)jflags;
    NCI_ITM itmlst[] =
...
JNIEXPORT jint JNICALL Java_jTraverser_Database_getFlags(JNIEnv * env, jobject obj, jobject jnid) {
  int nid, status;
  jfieldID nid_fid;
  jclass cls = (*env)->GetObjectClass(env, jnid);
...
JNIEXPORT jstring JNICALL Java_jTraverser_Database_getOriginalPartName(JNIEnv * env, jobject obj, jobject jnid) {
...
JNIEXPORT void JNICALL Java_jTraverser_Database_setSubtree
    (JNIEnv * env, jobject obj, jobject jnid, jint context)
{
...
JNIEXPORT void JNICALL Java_jTraverser_Database_executeDelete(JNIEnv * env, jobject obj, jint context) {
...
JNIEXPORT jobjectArray JNICALL Java_jTraverser_Database_getWild
...
JNIEXPORT jboolean JNICALL Java_jTraverser_Database_isOn(JNIEnv * env, jobject obj, jobject jnid, jint context) {
  int nid, status;
  jfieldID nid_fid;
  jclass cls = (*env)->GetObjectClass(env, jnid);
  nid_fid = (*env)->GetFieldID(env, cls, "datum", "I");
...
JNIEXPORT jobject JNICALL Java_jTraverser_Database_getDefault(JNIEnv * env, jobject obj, jint context) {
  jclass cls;
  jmethodID constr;
  jvalue args[1];
  int status, nid;
...
JNIEXPORT jint JNICALL Java_jTraverser_Database_doAction(JNIEnv * env, jobject obj, jobject jnid, jint context) {
  int nid, status;
  jfieldID nid_fid;
  jclass cls = (*env)->GetObjectClass(env, jnid);
...
JNIEXPORT void JNICALL Java_jTraverser_Database_doDeviceMethod
...
JNIEXPORT jlong JNICALL Java_jTraverser_Database_saveContext(JNIEnv * env, jobject obj) {
  void *context = TreeSaveContext();
/*//	printf("Saved context: %x\n", context);*/
  return (long)context;
}

JNIEXPORT void JNICALL Java_jTraverser_Database_restoreContext(JNIEnv * env, jobject obj, void *context) {
...
JNIEXPORT jint JNICALL Java_jTraverser_Database_getCurrentShot(JNIEnv * env, jobject obj, jstring jname) {
  const char *name = (*env)->GetStringUTFChars(env, jname, 0);
...
JNIEXPORT void JNICALL Java_jTraverser_Database_setCurrentShot
...
JNIEXPORT void JNICALL Java_jTraverser_Database_setEvent(JNIEnv * env, jobject obj, jstring jname) {
  const char *name = (*env)->GetStringUTFChars(env, jname, 0);
  MDSEvent((char *)name, 0, 0);
  (*env)->ReleaseStringUTFChars(env, jname, name);
}

JNIEXPORT jstring JNICALL Java_jTraverser_Database_getMdsMessage(JNIEnv * env, jobject obj, jint status) {
