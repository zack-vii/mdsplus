...
public abstract class Data implements Serializable{
    ...
    private static final long serialVersionUID = -4267307755111590736L;
    ...
    public void AddDataListener(final DataListener dl) {
        this.data_listeners.addElement(dl);
    }

    public void FireDataEvent() {
        for(int i = 0; i < this.data_listeners.size(); i++)
            (this.data_listeners.elementAt(i)).DataChanged(this);
    }
