...
class AsdexDataProvider extends MdsDataProvider{
    class SimpleWaveData implements WaveData{
        ...
        public int getNumDimension() throws IOException {
            String expr;
            if(_jscope_set) expr = "shape(_jscope_" + v_idx + ")";
            else{
                _jscope_set = true;
        ...
        public double[] GetXDoubleData() {
            try{
                if(currXData == null) currXData = GetXRealData();
        ...
        public long[] GetXLongData() {
            try{
                if(currXData == null) currXData = GetXRealData();
                if(!currXData.isLong) return null;
        ...
        public float[] GetYData() throws IOException {
            String expr;
            if(_jscope_set) expr = "dim_of(_jscope_" + v_idx + ", 1)";
            else{
                _jscope_set = true;
        ...
        public String GetTitle() throws IOException {
            String expr;
            if(_jscope_set) expr = "help_of(_jscope_" + v_idx + ")";
            else{
                _jscope_set = true;
        ...
        public String GetXLabel() throws IOException {
            ...
            if(in_x == null || in_x.length() == 0){
                String expr;
                if(_jscope_set) expr = "Units(dim_of(_jscope_" + v_idx + ", 1))";
                else{
                    _jscope_set = true;
        ...
        public String GetYLabel() throws IOException {
            String expr;
            if(_jscope_set) expr = "Units(_jscope_" + v_idx + ")";
            else{
                _jscope_set = true;
