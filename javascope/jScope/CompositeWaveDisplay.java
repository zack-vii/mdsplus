...
final public class CompositeWaveDisplay extends JApplet implements WaveContainerListener{
    ...
    public void init() {
        ...
        final WavePopup wave_popup = new MultiWavePopup(new SetupWaveformParams(CompositeWaveDisplay.frame, "Waveform Params"), new ProfileDialog(null, null));
        ...
        switch(event_id){
            case WaveContainerEvent.WAVEFORM_EVENT:
                ...
                if(w instanceof MultiWaveform){
                    ...
                    final String n = mw.getSignalName(we.signal_idx);
                    if(n != null) s = s + " " + n;
                }
