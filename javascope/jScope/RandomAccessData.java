...
public class RandomAccessData
{
   ...
   int position = 0;
     ...
     * @return long
     */
    public long getFilePointer() {return (long)position;}
    /**
     * Insert the method's description here.
     ...
     * @exception java.io.IOException The exception description.
     */
    public void seek(long pos) throws java.io.IOException{position = (int)pos;}
    /**
     * Insert the method's description here.
     * Creation date: (15/10/99 17:16:08)
     * @param amount int
     */
    public void skipBytes(int amount){position += amount;}
}