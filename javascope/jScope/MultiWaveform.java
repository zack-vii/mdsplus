...
public class MultiWaveform extends Waveform{
    ...
    public void Autoscale() {
        ...
        for(i = 0; i < this.signals.size(); i++){
            ...
            v = this.signals.elementAt(i).getXmin();
            if(v < xmin) xmin = v;
            v = this.signals.elementAt(i).getXmax();
            if(v > xmax) xmax = v;
            v = this.signals.elementAt(i).getYmin();
            if(v < ymin) ymin = v;
            v = this.signals.elementAt(i).getYmax();
            if(v > ymax) ymax = v;
        }
    ...
    public void AutoscaleY() {
        ...
        final double prev_xmin = this.waveform_signal.getXmin(), prev_xmax = this.waveform_signal.getXmax();
        double ymin = Double.POSITIVE_INFINITY, ymax = Double.NEGATIVE_INFINITY;
        double v;
        for(int i = 0; i < this.signals.size(); i++){
            if(this.signals.elementAt(i) == null) continue;
    ...
    public int GetMarkerStep(final int idx) {
        if(idx < this.signals.size()){ return this.signals.elementAt(idx).getMarkerStep(); }
        return 0;
    }
    ...
    public void ResetScales() {
        ...
        if(this.orig_signals != null){
            this.signals = this.orig_signals;
            for(int i = 0; i < this.signals.size(); i++)
                if(this.signals.elementAt(i) != null) this.signals.elementAt(i).ResetScales();
        }
    ...
    public void signalUpdated(final boolean changeLimits) {
        ...
        for(int i = 1; i < this.signals.size(); i++){
            ...
            if(this.signals.elementAt(i).isLongX()){
                anyLongX = true;
                this.waveform_signal.setXLimits(this.signals.elementAt(i).getXmin(), this.signals.elementAt(i).getXmax(), Signal.AT_CREATION);
                break;
            }
        }
        for(int i = 1; i < this.signals.size(); i++){
            ...
            if(anyLongX && !(this.signals.elementAt(i)).isLongX()) continue;
            if(this.waveform_signal.getXmax() < this.signals.elementAt(i).getXmax()) this.waveform_signal.setXLimits(this.waveform_signal.getXmin(), this.signals.elementAt(i).getXmax(), Signal.SIMPLE);
            if(this.waveform_signal.getXmin() > this.signals.elementAt(i).getXmin()) this.waveform_signal.setXLimits(this.signals.elementAt(i).getXmin(), this.waveform_signal.getXmax(), Signal.SIMPLE);
            if(this.waveform_signal.getYmax() < this.signals.elementAt(i).getYmax()) this.waveform_signal.setYmax(this.signals.elementAt(i).getYmax(), Signal.SIMPLE);
            if(this.waveform_signal.getYmin() > this.signals.elementAt(i).getYmin()) this.waveform_signal.setYmin(this.signals.elementAt(i).getYmin(), Signal.SIMPLE);
        }
        this.repaint();
    }
    ...
    void UpdateLimits() {
        ...
        for(i = 0; i < this.signals.size(); i++){
            ...
            if(this.signals.elementAt(i).isLongX()){
                anyLongX = true;
                this.waveform_signal.setXLimits(this.signals.elementAt(i).getXmin(), this.waveform_signal.getXmax(), Signal.AT_CREATION);
                break;
            }
        }
        for(i = 0; i < this.signals.size(); i++){
            ...
            // Avoid introducing 0 as limits for absolute times
            if(anyLongX && !this.signals.elementAt(i).isLongX()) continue;
            if(this.waveform_signal.getXmax() < this.signals.elementAt(i).getXmax()) this.waveform_signal.setXLimits(this.waveform_signal.getXmin(), this.signals.elementAt(i).getXmax(), Signal.AT_CREATION);
            if(this.waveform_signal.getXmin() > this.signals.elementAt(i).getXmin()) this.waveform_signal.setXLimits(this.signals.elementAt(i).getXmin(), this.waveform_signal.getXmax(), Signal.AT_CREATION);
            if(this.waveform_signal.getYmax() < this.signals.elementAt(i).getYmax()) this.waveform_signal.setYmax(this.signals.elementAt(i).getYmax(), Signal.AT_CREATION);
            if(this.waveform_signal.getYmin() > this.signals.elementAt(i).getYmin()) this.waveform_signal.setYmin(this.signals.elementAt(i).getYmin(), Signal.AT_CREATION);
        }
    }
