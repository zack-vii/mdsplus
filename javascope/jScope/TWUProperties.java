...
public class TWUProperties{
    ...
    /* -------------------------------------------------------------------- */
    // Constructors
    public TWUProperties(String SigURL){
        this(SigURL, null);
    }

    public TWUProperties(String SigURL, String user_agent){
    ...
    private static String CompleteURL(String in) {
    ...
    public String Title() {
        ...
        if(title == null) title = signalProps.getProperty("SignalName");
        return title;
    }
    ...
    public boolean Equidistant() {
        return (Incrementing() || Decrementing()) && signalProps.getProperty("Signal.Minimum") != null && signalProps.getProperty("Signal.Maximum") != null;
    }
    ...
    public boolean equals(String other_url) {
        try{
    ...
    public boolean notEquals(String other_url) {
