...
final public class MdsMessage extends Object
{
    ...
    public MdsMessage(String s){this(s, null);}
    public MdsMessage(byte c){this(c, null);}
    ...
    public void useCompression(boolean use_cmp){status = (use_cmp ? SUPPORTS_COMPRESSION | 5 : 0);}
...
//        dis.read(header_b);
        ...
        if(swap)
        {
            ...
            idx += 4;
            length = (int)ByteToShortSwap(header_b, idx);;
            idx += 2;
        }
        else
        {
            ...
            idx += 4;
            length = (int)ByteToShort(header_b, idx);;
            idx += 2;
        }
        nargs = header_b[idx++];
