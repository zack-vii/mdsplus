...
final class UniversalDataProvider implements DataProvider{
    ...
    protected DataProvider SelectProvider(String spec) {
        if(spec.startsWith("rfx:")) return rfx;
        if(spec.startsWith("ftu:")) return ftu;
        if(spec.startsWith("twu:")) return twu;
        if(spec.startsWith("jet:")) return jet;
        if(spec.startsWith("jetmds:")) return jetmds;
        if(spec.startsWith("ts:")) return ts;
        if(spec.startsWith("asd:")) return asd;
        error = "Unknown experiment";
        return null;
    }

    protected static String RemoveExp(String spec) {
    ...
    public void Update(String exp, long s) {
        if(exp == null) return;
        if(exp.equals("rfx") && rfx != null) rfx.Update(exp, s);
        else if(exp.equals("ftu") && ftu != null) ftu.Update(exp, s);
        else if(exp.equals("twu") && twu != null) twu.Update(exp, s);
        else if(exp.equals("jet") && jet != null) jet.Update(null, s);
        else if(exp.equals("jetmds") && jetmds != null) jetmds.Update(null, s);
        else if(exp.equals("ts") && ts != null) ts.Update(null, s);
        else if(exp.equals("asd") && asd != null) asd.Update(null, s);
        error = null;
    }
